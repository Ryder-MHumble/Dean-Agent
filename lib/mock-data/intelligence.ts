import type { PolicyItem, TechTrend, Competitor } from "@/lib/types/intelligence";
...
export const mockPolicies: PolicyItem[] = [
  ...
  },
  {
    ...
    detail:
      "科技部「新一代人工智能」重大专项申报，聚焦大模型、具身智能、AI for Science三大方向。我院在大模型方向有基础，具身智能方向需加强。建议联合王教授团队以「大模型+具身智能」交叉方向申报，突出差异化优势。材料准备进度30%，需加快推进。",
  },
  {
    id: "p3",
    name: "高校AI人才培养专项基金",
    ...
    detail:
      "教育部面向高校AI人才培养的专项基金，支持课程建设、实验室升级和师资培训。我院在AI人才培养方面有一定基础，但该基金竞争激烈且资金规模相对较小，建议作为补充性申报项目。",
  },
  {
    id: "p4",
    name: "中关村人工智能产业扶持计划",
    ...
    detail:
      "海淀区政府针对中关村AI企业和机构的产业扶持计划，支持算力基础设施、模型开发和应用落地。资金规模较小但审批效率高，可考虑与算力平台二期项目联合申报。",
  },
];
