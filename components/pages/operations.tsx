        ...
        <div className="relative">
          ...
          >
            <div className="flex flex-col items-center">
              <div className="rounded bg-blue-500 px-1.5 py-0.5 text-[9px] font-medium text-white">
                {"今日"}
              </div>
              <div className="h-full w-px bg-blue-500/30" />
            </div>
          </div>

          {/* Project rows */}
          {projects.map((project) => (
            <div key={project.name} className="flex items-center border-b py-4">
              ...
              <div className="relative grid flex-1 grid-cols-6">
                {project.bars.map((bar) => (
                  <div
                    key={bar.label}
                    className={`col-start-${bar.start} col-span-${bar.width} flex h-7 items-center justify-center rounded border text-[10px] font-medium ${bar.color} ${bar.textColor}`}
                    style={{
